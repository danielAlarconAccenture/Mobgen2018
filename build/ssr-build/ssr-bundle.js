...
// CONCATENATED MODULE: ./style/colors.js
var COLORS = {
	GRAY: '#7F7F7F',
	WHITE: '#FFFFFF',
	BLACK: '#161616',
...
// EXTERNAL MODULE: ./assets/fonts/Graphik-Regular.ttf
var Graphik_Regular = __webpack_require__("pJuJ");
var Graphik_Regular_default = /*#__PURE__*/__webpack_require__.n(Graphik_Regular);
...
Object(styled_components_es["c" /* injectGlobal */])(fonts__templateObject, Graphik_Black_default.a, Graphik_Black_default.a, Graphik_Black_default.a, Graphik_Light_default.a, Graphik_Light_default.a, Graphik_Light_default.a, Graphik_Regular_default.a, Graphik_Regular_default.a, Graphik_Regular_default.a);
...
function Fireworks__taggedTemplateLiteralLoose(strings, raw) { strings.raw = raw; return strings; }
...
var Fireworks_Fireworks = function (_Component) {
	_inherits(Fireworks, _Component);

	Fireworks.prototype.init = function init() {
		var _this2 = this;
		...
		this.renderAnimation = anime_min_default()({
			duration: Infinity,
		...
		document.addEventListener(this.tap, function (e) {
			_this2.renderAnimation.play();
			_this2.updateCoords(e);
			_this2.animateParticules(_this2.pointerX, _this2.pointerY);
		}, false);
	...
	Fireworks.prototype.updateCoords = function updateCoords(e) {
		this.pointerX = e.clientX || e.touches[0].clientX;
		this.pointerY = e.clientY || e.touches[0].clientY;
	};

	Fireworks.prototype.setParticuleDirection = function setParticuleDirection(p) {
		var angle = anime_min_default.a.random(0, 360) * Math.PI / 180;
		var value = anime_min_default.a.random(50, 180);
		var radius = [-1, 1][anime_min_default.a.random(0, 1)] * value;
		return {
	...
	Fireworks.prototype.createParticule = function createParticule(x, y) {
		var _this3 = this;

		var p = {};
		p.x = x;
		p.y = y;
		p.color = this.colors[anime_min_default.a.random(0, this.colors.length - 1)];
		p.radius = anime_min_default.a.random(16, 32);
		p.endPos = this.setParticuleDirection(p);
		p.draw = function () {
			_this3.ctx.beginPath();
			_this3.ctx.arc(p.x, p.y, p.radius, 0, 2 * Math.PI, true);
			_this3.ctx.fillStyle = p.color;
			_this3.ctx.fill();
		};
		return p;
	};

	Fireworks.prototype.createCircle = function createCircle(x, y) {
		var _this4 = this;
		...
		p.lineWidth = 6;
		p.draw = function () {
			_this4.ctx.globalAlpha = p.alpha;
			_this4.ctx.beginPath();
			_this4.ctx.arc(p.x, p.y, p.radius, 0, 2 * Math.PI, true);
			_this4.ctx.lineWidth = p.lineWidth;
			_this4.ctx.strokeStyle = p.color;
			_this4.ctx.stroke();
			_this4.ctx.globalAlpha = 1;
		};
		return p;
	};

	Fireworks.prototype.renderParticule = function renderParticule(anim) {
		for (var i = 0; i < anim.animatables.length; i++) {
			anim.animatables[i].target.draw();
		}
	};

	Fireworks.prototype.animateParticules = function animateParticules(x, y) {
		var circle = this.createCircle(x, y);
		var particules = [];
		for (var i = 0; i < this.numberOfParticules; i++) {
			particules.push(this.createParticule(x, y));
		}
		anime_min_default.a.timeline().add({
			targets: particules,
			x: function x(p) {
				return p.endPos.x;
			},
			...
			radius: 0.1,
			duration: anime_min_default.a.random(1200, 1800),
			easing: 'easeOutExpo',
			update: this.renderParticule
		}).add({
			targets: circle,
			radius: anime_min_default.a.random(80, 160),
			lineWidth: 0,
			alpha: {
				value: 0,
				easing: 'linear',
				duration: anime_min_default.a.random(600, 800)
			},
			duration: anime_min_default.a.random(1200, 1800),
			easing: 'easeOutExpo',
			update: this.renderParticule,
	...
	function Fireworks() {
		...
		_this.setCanvasSize = _this.setCanvasSize.bind(_this);
		_this.updateCoords = _this.updateCoords.bind(_this);
		_this.setParticuleDirection = _this.setParticuleDirection.bind(_this);
		_this.createParticule = _this.createParticule.bind(_this);
		_this.createCircle = _this.createCircle.bind(_this);
		_this.renderParticule = _this.renderParticule.bind(_this);
		_this.animateParticules = _this.animateParticules.bind(_this);
		return _this;
	}

	Fireworks.prototype.componentDidMount = function componentDidMount() {
		this.init();
	};
...
// CONCATENATED MODULE: ./routes/home/ClickForMagicWrap.js
...
var StyledParagraph = styled_components_es["b" /* default */].p(Paragraph__templateObject, function (_ref) {
	var color = _ref.color;
	return color ? '' + color : 'none';
});

var Paragraph_Paragraph = function Paragraph(_ref2) {
	var text = _ref2.text,
	    color = _ref2.color;
...
var StyledH3 = styled_components_es["b" /* default */].h3(H3__templateObject, function (_ref) {
	var color = _ref.color;
	return color ? '' + color : 'none';
}, media.tablet(_templateObject2), media.phone(_templateObject3));

var H3_H3 = function H3(_ref2) {
	var text = _ref2.text,
	    color = _ref2.color;
	return Object(preact_min["h"])(
		StyledH3,
...
function Subtitle__taggedTemplateLiteralLoose(strings, raw) { strings.raw = raw; return strings; }





var Subtitle_StyledParagraph = styled_components_es["b" /* default */].p(Subtitle__templateObject, function (_ref) {
	var color = _ref.color;
	return color ? '' + color : 'none';
}, media.tablet(Subtitle__templateObject2), media.phone(Subtitle__templateObject3));

var Subtitle_Subtitle = function Subtitle(_ref2) {
	var text = _ref2.text,
	    color = _ref2.color;
	return Object(preact_min["h"])(
		Subtitle_StyledParagraph,
		{ color: color },
		text
	);
};
...
// CONCATENATED MODULE: ./components/Stripe/index.js
var Stripe__templateObject = Stripe__taggedTemplateLiteralLoose(['\n\t&:after {\n\t\tbackground: ', ';\n\t\tcontent: \'\';\n\t\tdisplay: block;\n\t\theight: 2px;\n\t\tposition: relative;\n\t\twidth: 24px;\n\t}\n'], ['\n\t&:after {\n\t\tbackground: ', ';\n\t\tcontent: \'\';\n\t\tdisplay: block;\n\t\theight: 2px;\n\t\tposition: relative;\n\t\twidth: 24px;\n\t}\n']);

function Stripe__taggedTemplateLiteralLoose(strings, raw) { strings.raw = raw; return strings; }
...
function BottomWrap__taggedTemplateLiteralLoose(strings, raw) { strings.raw = raw; return strings; }
	...
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				null,
				NewYearWrap__ref2,
				Object(preact_min["h"])(components_Subtitle, { text: 'BEST WISHES,', color: COLORS.GRAY }),
				Object(preact_min["h"])(components_Subtitle, { text: 'MUCH LOVE,', color: COLORS.GRAY }),
				Object(preact_min["h"])(components_Subtitle, { text: 'THE MOBGEN TEAM', color: COLORS.GRAY })
			),
			Object(preact_min["h"])(
				SparkWrap,
				null,
...
function Logo__taggedTemplateLiteralLoose(strings, raw) { strings.raw = raw; return strings; }
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					ClickForMagicWrap,
					null,
					Object(preact_min["h"])(components_Paragraph, {
...
module.exports = {"make":"make__Iq3Q4"};
...
module.exports = __webpack_require__.p + "93cb83428bbb54d7ca14f0ed275f5592.ttf";
